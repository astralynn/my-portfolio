    ...
    <div>
      <section className={HomeStyle['home']}>
        ...
        <div className={HomeStyle['home-desc']}>
          ...
          <p>
          Верстку и создание сайтов изучал самостоятельно и на курсах от ВебКадеми. За это время сделал несколько проектов по верстке и сайтам под ключ. Найти их вы сможете в моем портфолио.

          </p>
          <img src="" alt="Amir image" className={HomeStyle['home-img']} />
          <p>
